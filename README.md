...
Installs into this project's `.claude/skills/`; add `-g` for every project. Re-run to update. For Codex, Cursor and other agents use `-a codex`, `-a cursor`, … (or drop `-a` to pick from a menu).
